"""
Django settings for childtrack_project project.
"""
...
ALLOWED_HOSTS = [
    'childtrack-backend.onrender.com',
    'localhost',
    '127.0.0.1',
    '.onrender.com',
]
...
ROOT_URLCONF = 'childtrack_project.urls'
...
DATABASES = {
    'default': dj_database_url.parse(
        os.getenv(
            'DATABASE_URL',
            'postgresql://childtrack8_user:dQKgKAzkoTdabCKAwvLkviWAZUtDKkzl@dpg-d6oem79aae7s73a7gthg-a/childtrack8'
        )
    )
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'teacher.views.custom_error_handler',
}
...
# Allowed image types (optional - for additional validation)
